-- Complete setup script for investments table
...
-- Now insert the data (you'll need to run the insert_investments.sql after this)
\echo 'Table created successfully. Now run the insert_investments.sql file to populate data.'