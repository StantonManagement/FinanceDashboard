...
export function generateExcelTemplate(): ArrayBuffer {
  ...
  const properties = [
    ...
    { code: 'S0011', name: '315 Elm Street', portfolio: 'Hartford 1', revenue: 14280, expenses: 5290 },
